...
//        faculty.setStudents(Collections.singleton(student));
//
//        when(facultyService.getByStudentId(anyLong())).thenReturn(faculty);
//
...
//                .andExpect(jsonPath("$.students[0].name").value("Harry"))
//                .andExpect(jsonPath("$.students[0].age").value("22"));
//    }
//    при прохождении теста получаю ошибку о том что факультет не привязывается к студенту
